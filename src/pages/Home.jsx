...
<div className=' col-md-6  text-end'>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" className='img-gra position-absolute o text-end d-flex ' width="100" height="100" fill="currentColor" class="bi bi-graph-up-arrow" viewBox="0 0 16 16">
