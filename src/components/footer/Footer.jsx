      ...
      <div className="container py-4">
        <div className="row">
          <div className="col-lg-4 mb-4">
            <h5 className="border-bottom pb-2 mb-3" style={{ borderColor: "#ffd700" }}>
              Sobre Nós
            </h5>
            <p className="fst-italic border-start ps-3" style={{ borderColor: "#ffd700" }}>
              "Um livro é um sonho que você segura em suas mãos. Cada página virada é uma porta para um novo mundo de
              emoções."
            </p>
          </div>
